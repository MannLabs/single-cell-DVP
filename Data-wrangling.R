...
contaminants <- read_tsv("./input/221109_common-contaminants_cRAP.tsv")
...
meta_distances <- read_csv("./input/meta_img-geometric-distance.csv") %>%
...
read_tsv("./input/TO_CONSTANTIN__scDVP_full_report.tsv.precursortable_uncorrected.tsv.formatted_for_iq.tsv.maxlfq_iq_protein_intensities.tsv.linearized.tsv") %>%
...
save(d_all_norm, file = "./output/d_all_norm.R")
save(statTable_all, file = "./output/statTable_all.R")
save(SA_incl_all, file = "./output/SA_incl_all.R")
save(CIn_lower_all, file = "./output/CIn_lower_all.R")
save(meta_pg, file = "./output/meta_pg.R")
save(statTable_all_n, file = "./output/statTable_all_n.R")
save(d_all, file = "./output/d_all.R")
save(meta_distances, file = "./output/meta_distances.R")
save(img_meta, file = "./output/img_meta.R")
save(img_fluovalues, file = "./output/img_fluovalues.R")
save(d_full_set, file = "./output/d_full_set.R")